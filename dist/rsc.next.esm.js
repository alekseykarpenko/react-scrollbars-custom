 ...
 */
const calcScrollForThumbOffset = (contentSize, viewportSize, trackSize, thumbSize, thumbOffset, reverse) => {
...
class Scrollbar extends React.Component {
    constructor(props) {
        ...
        this.handleTrackXClick = (ev, values) => {
            ...
            let target = calcScrollForThumbOffset(this.scrollValues.scrollWidth, this.scrollValues.clientWidth, trackInnerSize, thumbSize, thumbOffset, this.props.reverseX);
        ...
        this.handleTrackYClick = (ev, values) => {
            ...
            const target = calcScrollForThumbOffset(this.scrollValues.scrollHeight, this.scrollValues.clientHeight, getInnerHeight(this.trackYElement), thumbSize, values.offset - thumbSize / 2, this.props.reverseY) - (Number.parseFloat(getComputedStyle(this.trackYElement).paddingTop) || 0);
            if (this.props.trackClickBehavior === TRACK_CLICK_BEHAVIOR.JUMP) {
                this.scrollerElement.scrollTop = target;
            }
            else if (this.props.reverseY) {
                const reversedScrollTop = this.scrollValues.clientHeight -
        ...
        this.handleThumbXDrag = (data) => {
            ...
            this.scrollerElement.scrollLeft = calcScrollForThumbOffset(this.scrollValues.scrollWidth, this.scrollValues.clientWidth, trackInnerSize, thumbSize, offset, this.props.reverseX);
        ...
        this.handleThumbYDrag = (data) => {
            ...
            this.scrollerElement.scrollTop = calcScrollForThumbOffset(this.scrollValues.scrollHeight, this.scrollValues.clientHeight, trackInnerSize, thumbSize, offset, this.props.reverseY);
