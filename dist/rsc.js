 ...
 */
var calcScrollForThumbOffset = function calcScrollForThumbOffset(contentSize, viewportSize, trackSize, thumbSize, thumbOffset, reverse) {
  if (!thumbOffset || !thumbSize || viewportSize >= contentSize) {
    return reverse ? viewportSize - contentSize : 0;
  }
  // TODO: revere
  var position = thumbOffset * (contentSize - viewportSize) / (trackSize - thumbSize);
  ...
  function Scrollbar(props) {
    ...
    _this.getScrollState = function (force) {
      ...
      if (_this.scrollerElement) {
        ...
        scrollState.scrollTop = _this.props.reverseY ? _this.scrollerElement.scrollHeight - _this.scrollerElement.clientHeight + _this.scrollerElement.scrollTop : _this.scrollerElement.scrollTop;
        scrollState.scrollLeft = _this.props.reverseX ? _this.scrollerElement.scrollWidth - _this.scrollerElement.clientWidth + _this.scrollerElement.scrollLeft : _this.scrollerElement.scrollLeft;
    ...
    _this.scrollToTop = function () {
      if (_this.scrollerElement) {
        _this.scrollerElement.scrollTop = _this.props.reverseY ? _this.scrollerElement.scrollHeight - _this.scrollerElement.clientHeight : 0;
      }
      return _this;
    };
    /**
    ...
    _this.scrollToLeft = function () {
      if (_this.scrollerElement) {
        _this.scrollerElement.scrollLeft = _this.props.reverseX ? _this.scrollerElement.scrollWidth - _this.scrollerElement.clientWidth : 0;
      }
      return _this;
    };
    /**
    ...
    _this.scrollToBottom = function () {
      if (_this.scrollerElement) {
        _this.scrollerElement.scrollTop = _this.props.reverseY ? 0 : _this.scrollerElement.scrollHeight - _this.scrollerElement.clientHeight;
      }
      return _this;
    };
    /**
    ...
    _this.scrollToRight = function () {
      if (_this.scrollerElement) {
        _this.scrollerElement.scrollLeft = _this.props.reverseX ? 0 : _this.scrollerElement.scrollWidth - _this.scrollerElement.clientWidth;
      }
      return _this;
    };
    /**
    ...
    _this.handleTrackXClick = function (ev, values) {
      ...
      var target = calcScrollForThumbOffset(_this.scrollValues.scrollWidth, _this.scrollValues.clientWidth, trackInnerSize, thumbSize, thumbOffset, _this.props.reverseX);
    ...
    _this.handleTrackYClick = function (ev, values) {
      ...
      var target = calcScrollForThumbOffset(_this.scrollValues.scrollHeight, _this.scrollValues.clientHeight, getInnerHeight(_this.trackYElement), thumbSize, values.offset - thumbSize / 2, _this.props.reverseY) - (Number.parseFloat(getComputedStyle(_this.trackYElement).paddingTop) || 0);
      if (_this.props.trackClickBehavior === TRACK_CLICK_BEHAVIOR.JUMP) {
        _this.scrollerElement.scrollTop = target;
      } else if (_this.props.reverseY) {
        var reversedScrollTop = _this.scrollValues.clientHeight - _this.scrollValues.scrollHeight + _this.scrollValues.scrollTop;
        _this.scrollerElement.scrollTop = reversedScrollTop < target ? reversedScrollTop + _this.scrollValues.clientHeight : reversedScrollTop - _this.scrollValues.clientHeight;
      } else {
    ...
    _this.handleThumbXDrag = function (data) {
      ...
      _this.scrollerElement.scrollLeft = calcScrollForThumbOffset(_this.scrollValues.scrollWidth, _this.scrollValues.clientWidth, trackInnerSize, thumbSize, offset, _this.props.reverseX);
    ...
    _this.handleThumbYDrag = function (data) {
      ...
      _this.scrollerElement.scrollTop = calcScrollForThumbOffset(_this.scrollValues.scrollHeight, _this.scrollValues.clientHeight, trackInnerSize, thumbSize, offset, _this.props.reverseY);
